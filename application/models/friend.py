...
class Friend(Base, SerializerMixin):
    ...
    serialize_rules = (
        "-requesting_user.friends_sent",
        "-requesting_user.friends_received",
        "-requesting_user.routes_joined",
        "-requesting_user.routes_owned",
        "-requesting_user.role",
        "-requesting_user.email",
        "-target_user.friends_sent",
        "-target_user.friends_received",
        "-target_user.routes_joined",
        "-target_user.routes_owned",
        "-target_user.role",
        "-target_user.email",
    )
